...
def ocr(img, c1, c2, c3, c4, c5, c6, c7, c8):
    ...
    results2 = reader.readtext(col2, paragraph=False, detail=1, min_size= 2,  width_ths= 0.8, allowlist= "1234567890.")
    results3 = reader.readtext(col3, paragraph=False, detail=1, width_ths= 0.8, allowlist= "1234567890^-/uL")
    results4 = reader.readtext(col4, paragraph=False, detail=1, width_ths= 0.8, allowlist= "HL")
...
def ocr_rapidpoint(im):
    ...
    df[["Text", "BRy", "TLx"]].to_csv("C:\\Users\\shimadzu\\Documents\\t-icu\\rp.csv",encoding='utf-8-sig')
    reqd_text = df.loc[(df["Text"] == "pOz")| (df["Text"] == "poz")|(df["Text"] == "pO2"), "BRy"]
